...
export default function ProfileScreen() {
  ...
  const handleSendImmediateNotification = async () => {
    if (sendingNotification) {
      console.log('ProfileScreen: Already sending notification');
      return;
    }

    try {
      console.log('ProfileScreen: Sending immediate test notification...');
      ...
      console.log('ProfileScreen: ✓ Immediate notification sent');
      HapticFeedback.success();
      Alert.alert(
        'Notification Sent!',
      ...
      console.error('ProfileScreen: Error sending immediate notification:', err);
      HapticFeedback.error();
  ...
  const handleSendDelayedNotification = async () => {
    ...
    try {
      console.log('ProfileScreen: Scheduling delayed test notification...');
      setSendingNotification(true);
      HapticFeedback.medium();
      ...
      console.log('ProfileScreen: ✓ Delayed notification scheduled for 5 seconds');
      HapticFeedback.success();
      Alert.alert(
