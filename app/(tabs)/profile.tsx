  ...
  useEffect(() => {
    ...
    const wordsSubscription = supabase
      ...
      .on(
        ...
        (payload) => {
          console.log('ProfileScreen: user_words change detected:', payload);
          fetchProfileData();
        }
      )
      .subscribe();
    ...
    const booksSubscription = supabase
      ...
      .on(
        ...
        (payload) => {
          console.log('ProfileScreen: user_books change detected:', payload);
          fetchProfileData();
        }
      )
      .subscribe();
    ...
    const momentsSubscription = supabase
      ...
      .on(
        ...
        (payload) => {
          console.log('ProfileScreen: moments change detected:', payload);
          fetchProfileData();
        }
      )
      .subscribe();
