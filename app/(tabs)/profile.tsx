...
export default function ProfileScreen() {
  ...
  const handleViewMoreMoments = () => {
    try {
      console.log('ProfileScreen: View more moments pressed - opening all moments bottom sheet');
      allMomentsRef.current?.present();
    } catch (err) {
      console.error('ProfileScreen: Error opening all moments bottom sheet:', err);
    }
  };
