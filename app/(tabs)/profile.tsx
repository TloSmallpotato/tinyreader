...
export default function ProfileScreen() {
  ...
  useEffect(() => {
    ...
    const wordsSubscription = supabase
      ...
      .on(
        ...
        (payload) => {
          console.log('ProfileScreen: user_words change detected:', payload.eventType);
    ...
    const booksSubscription = supabase
      ...
      .on(
        ...
        (payload) => {
          console.log('ProfileScreen: user_books change detected:', payload.eventType);
          debouncedFetchProfileData();
        }
      )
      .subscribe((status) => {
    ...
    const momentsSubscription = supabase
      ...
      .on(
        ...
        (payload) => {
          console.log('ProfileScreen: moments change detected:', payload.eventType);
          debouncedFetchProfileData();
        }
      )
      .subscribe((status) => {
  ...
  const fetchProfileData = async () => {
    ...
    try {
      ...
      console.log('ProfileScreen: Stats - Words:', totalWordsCount, 'Books:', totalBooksCount, 'Moments:', momentsThisWeekCount);
